    ...
    if (isset ($_GET ["nonce"]) && $_GET ["nonce"] == wp_create_nonce ("adinserter_data")) {
      if (isset ($_GET ["ai-oauth-code"]) && $_GET ["ai-oauth-code"] != '') {
        ...
        if ($oauth_code !== false) {
          ...
          $redirect_url = admin_url ($settings_page.$url_safe_mode);
...
<form id="ai-form" class="no-select ai-rounded<?php echo function_exists ('ai_settings_flags') ? ai_settings_flags () : ''; ?>" style="float: left;" action="<?php echo esc_attr ($save_url); ?>" method="post" name="ai_form" start="<?php echo $start; ?>" end="<?php echo $end; ?>" gmt="<?php echo get_option ('gmt_offset') * 3600 * 1000; ?>" ai-settings="<?php echo base64_encode (admin_url ($settings_page.$url_safe_mode)); ?>" ai-value="<?php echo base64_encode (wp_create_nonce ("adinserter_data")); ?>">
...
?>
        <button type="button" class="ai-top-button ai-range-link" style="margin-right: 0px; outline: none;" data-address="<?php echo admin_url($settings_page.'&start='.$range_start.$url_safe_mode); ?>">
...
function code_block_list ($start, $end, $search_text, $show_all_blocks, $active_block) {
  ...
  for ($block = 1; $block <= 96; $block ++) {
    ...
    $settings_page = get_menu_position () == AI_SETTINGS_SUBMENU ? 'options-general.php?page=ad-inserter.php' : 'admin.php?page=ad-inserter.php';
    $edit_url = admin_url ($settings_page) . '&start=' . (intval (($block - 1) / 16) * 16 + 1) . '&tab=' . $block . $url_safe_mode;
...
?>
      ...
      <div class="ai-form ai-rounded" style="height: 90px; padding: 8px 4px 8px 12px;">
        <a href='https://www.ezoic.com/' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-8" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-8.jpg" /></a>
      </div>
<?php
      break;
    case 7:
...
?>
      ...
      <div class="ai-form ai-rounded" style="height: 90px; padding: 8px 4px 8px 12px;">
        <a href='https://www.ezoic.com/humix-video/' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-6" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-6.png" /></a>
      </div>
<?php
      break;
...
<?php   break; case 3: ?>
            <a href="https://www.flickify.com/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-5" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-5.png" /></a>
<?php   break;
      } ?>
          </div>
...
<?php   break;
        case 2:
        ?>
            <a href="https://www.ezoic.com/humix-video/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-4" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-4.png" /></a>
<?php   break;
        case 3:
?>
<!--            <a href='https://adinserter.pro/documentation/ad-blocking-detection' class="clear-link" title="<?php _e ('Ad blocking detection and content protection', 'ad-inserter'); ?>" target="_blank"><img id="ai-adb" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ai-adb.png" /></a>-->
...
<!--            <a href='https://www.media.net/program?ha=e9Pw4uwo2Uw/5xjjsB3lnYZZWUI+hzRSONzDaYA9EwX+3jg/PJYwFshOFEjop5NH2wRNDfr357ZTY1zlhCk7zw%3D%3D&loc=2' class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-media-9" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>contextual-9.gif" /></a>-->
            <a href="https://www.ezoic.com/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-7" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-7.jpg" /></a>
<?php   break; case 1: ?>
<!--            <a href="https://adinserter.pro/documentation/black-and-white-lists#geo-targeting" class="clear-link" title="Geotargeting - black/white-list countries" target="_blank"><img id="ai-pro-3" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ai-countries-250.png" /></a>-->
            <a href="https://underdogmedia.com/edge-publisher-adinserter/" class="clear-link" title="<?php _e ('Maximize Revenue', 'ad-inserter'); ?>" target="_blank"><img id="ai-um-2" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>um-2.png" /></a>
<?php   break; case 2: ?>
...
<?php   break;
        case 1:
        ?>
            <a href="https://www.ezoic.com/products/" class="clear-link" title="<?php _e ('Looking for AdSense alternative?', 'ad-inserter'); ?>" target="_blank"><img id="ai-ez-3" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>ez-3.png" /></a>
<?php   break;
        case 2:
?>
            <a href='https://www.infolinks.com/publishers/?kid=3114832&loc=2' class="clear-link" title="<?php _e ('Use Infolinks ads with Adsense to earn more', 'ad-inserter'); ?>" target="_blank"><img id="ai-info-2" src="<?php echo AD_INSERTER_PLUGIN_IMAGES_URL; ?>info-2.jpg" /></a>
